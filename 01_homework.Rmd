...
plot(log2(area)  ̃ elevation, pch=16, xlim=c(170,280))# NB: Doubling the area increases log2(area) by 1.0
text(log2(area)  ̃ elevation,labels=row.names(Manitoba.lakes), pos=4)text(log2(area)  ̃ elevation, labels=area, pos=2)
